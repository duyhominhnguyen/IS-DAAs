...
from config import RPOConfig
import os
from src.scripxts.utils import *
        ...
        for batch in train_dataloader:
            ...
            with accelerator.accumulate(policy):
                with accelerator.autocast():
                    ...
                    losses = -F.logsigmoid(config.beta * logits) - config.beta * config.eta * chosen_logps
                    loss = losses.mean()
